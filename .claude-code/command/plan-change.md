...
- Orients itself in the repository and high-level documentation under `doc/spec/` and related docs.
...
2. If no workItemRefHint:
   - Discover existing specs by scanning: `doc/changes/**/chg-*-spec.md`.
